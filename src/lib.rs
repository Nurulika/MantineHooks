...
#[derive(Debug)]
pub struct MantineHooksProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MantineHooksProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MantineHooks processing");
    
    let mut processor = MantineHooksProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MantineHooksProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MantineHooksProcessor::new(false);
